...
export async function authenticateUser(userName, password) {
    console.log("Sending POST request to /api/user/register");
    const res = await fetch(`${"https://web-422-user-api-ashen.vercel.app"}/api/user/login`, {
        method: "POST",
...
export async function registerUser(userName, password, password2) {
    console.log("Sending POST request to /api/user/register");
    const res = await fetch(`${"https://web-422-user-api-ashen.vercel.app"}/api/user/register`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
